...
void counting()
{
	printf_s(str, "No of arrows:%d", count);
	...
	{
		printf_s(str, "NO of arrows:%d,NO OF ARROWS OVER GAME LOST", count);
...
void disp()
{
	...
	glLoadIdentity();
	glColor3f(1, 1, 0);
	bitmap_output(450, 450, "BLOCKSHOOTING", GLUT_BITMAP_TIMES_ROMAN_24);
	counting();
	//Drawing  of arrow
	glColor3f(0, 1, 1);
	glBegin(GL_LINES);
